#NORMALIZE FWI VALUES IN INITIAL CSV
...
MIN_bui = min(bui)
MIN_fwi = min(fwi)
#USE FORMULA Xnorm = (x-MIN)/(MAX-MIN) TO FIND NORMALIZED VALUES, APPEND VALUES TO LISTS
...
#CREATE NEW DATASET FROM NORMALIZED VALUES, SAVE AS CSV
